    ...
    <div className="">
      ...
      <Formik
        ...
        validate={(values) => {
          ...
          if (values.trade_license_docs?.length < 1) {
            errors.trade_license_docs = "Please add licence pdf.";
          }
          if (values.contract_file?.length < 1) {
            errors.contract_file = "Please add contract pdf.";
          }
          if (values.vender_agreement?.length < 1) {
            errors.vender_agreement = "Please add vender agreement pdf.";
          }
